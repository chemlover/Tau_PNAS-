...
void DihedralList::settings(int narg, char **arg)
{
  ...
  rewind(fp);
  int array_size = 100*(num+2); // Need to optimize this value...
  ...
  while(fgets(line,1024,fp)) { 
    ...
    kperiodic[idx] = force->numeric(ptr);
